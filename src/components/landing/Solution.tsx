...
const Solution = () => {
  return (
    <section id="solucion" className="relative py-16 md:py-[95px] overflow-hidden">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {steps.map((step, i) => (
            <div key={i} className="relative">
              ...
              <div className="p-6 pt-9 md:p-8 md:pt-10 rounded-2xl bg-gradient-card border border-border hover:border-primary/40 transition-smooth h-full glow-border">
